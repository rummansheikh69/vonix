    ...
    >
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        ...
        <div className="relative z-20 p-3 flex flex-col w-full h-full">
          <div className=" absolute -z-10 inset-0 left-0 w-full h-full bg-[radial-gradient(200px_200px_at_top_left,#111,transparent)] opacity-0 group-hover:opacity-100 transition-opacity duration-500 group-hover:scale-110" />
          <div className=" absolute -z-10 inset-0 w-full h-full bg-[radial-gradient(100px_100px_at_bottom_right,#111,transparent)] opacity-0 group-hover:opacity-100 transition-opacity duration-500 group-hover:scale-110" />
          ...
          <div className="relative z-30 h-20 w-full p-3 bg-black/30 backdrop-blur-[3px] group-hover:backdrop-blur-[12px] border border-[#81818150] rounded-xl group-hover:-translate-y-2 transition-all duration-500">
            {/* small card blur */}
            <div className=" px-2.5 py-1 absolute -top-4/6 group-hover:-translate-y-3 left-1/2 -translate-x-1/2 h-16 w-40 bg-zinc-100/20 backdrop-blur-[4px] rounded-t-2xl border-2 border-[#81818150] border-b-0 duration-500 opacity-0 group-hover:opacity-100 scale-90 group-hover:scale-100">
